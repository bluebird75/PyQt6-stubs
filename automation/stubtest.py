### Phil: This is stubtest.py from mypy 0.931 , copied here for internal modification. Only one
### change, ignoring the error "xxx is inconsistent, runtime is a classmethod but stub is not"
### Search for "Phil:" in the code to find it.
...
def _verify_static_class_methods(
    ...
    if inspect.isbuiltin(runtime):
        ...
        if probably_class_method and not stub.is_class:
            ### Phil: this is my only modification on stubtest.py
            ### We ignore this error because it is generated for every method of PyQt6-stubs.
            # yield "runtime is a classmethod but stub is not"
            pass
            ### Phil: end of modification here
