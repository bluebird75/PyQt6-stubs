...
class QObject(PyQt6.sip.wrapper):
    ...
    # note: QObjectT would be a better fit for types but mypy does not understand it.
    @typing.overload
    def findChild(self, types: typing.Tuple[typing.Type[QObject], ...], name: str = ..., options: Qt.FindChildOption = ...) -> 'QObjectT': ...
...
def pyqtSlot(*types: typing.Any, name: str = ..., result: typing.Union[str, T] = ..., revision: int = ...) -> typing.Any: ...
