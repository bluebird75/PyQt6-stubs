...
class QSslSocket(QTcpSocket):
    ...
    def disconnectFromHost(self) -> None: ...
    def connectToHost(self, hostName: str, port: int, mode: QtCore.QIODeviceBase.OpenModeFlag = ..., protocol: QAbstractSocket.NetworkLayerProtocol = ...) -> None: ...  # type: ignore[override]
    def resume(self) -> None: ...
